...
public class BasicDemo1 {
    ...
    public static void main(String[] args) 
         ...
         *      该Watcher会获取各种事件的通知
         */
        ZooKeeper zk = new ZooKeeper("node4:2181,node2:2181,node3:2181", 60000, new Watcher() {
            // 监控所有被触发的事件
        ...
        if (zk.exists("/node", true) == null) {
            ...
            System.out.println("查看/node节点数据:get /node => "
                    + new String(zk.getData("/hbase/ibmdeveloperworks/demo/test3,,1502098849690.28d9240934d53ac1e9b0a90579b47e24.", false, null)));
            /**
             * 查看根节点
